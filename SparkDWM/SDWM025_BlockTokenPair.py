...
def BlockTokenPairMap(data):
    ...
    elif excludeNumericBlocks and token.isdigit():
        #print('-- Num Token Rule: ', refID,token)
        isBlkToken = False
    elif len(token) < minBlkTokenLen:
    ...
    # Remainder Blocking Tokens
        ...
        return 'Yes'
            #skip = False
            #refBack = refID+ ',' +(str(position) + ',' +token)
            #return refBack
     
        
    #    blkTokenList.append(data)
